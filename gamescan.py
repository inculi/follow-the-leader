...
df = df.sort_values(by='total percent returns', ascending=False);df
...
df = df.sort_values(by='total percent returns per day', ascending=False);df
df = df[:500]
...
df = df.sort_values(by='trades per day', ascending=False);df
df = df[:250]
